    ...
    <div class="page-content">
        ...
        <div class="wt-bnr-inr overlay-wraper bg-center" style="background-image:url(images/banner/1.jpg);">
            ...
            <div class="section-full
                                                                ...
                                                                <div class="twm-job-self-top">
                                                                    ...
                                                                    <div class="twm-mid-content">
                                                                        ...
                                                                        <h4 class="twm-job-title">
                                                                            {{ $values['job_info']->title }} <span
                                                                                class="twm-job-post-duration">/ Posted on
                                                                                <?php echo date('d M Y', strtotime($values['job_info']->date)); ?></span></h4>
                                                                        <p class="twm-job-address"><i
                                                                                class="feather-map-pin"></i>
                                                                            {{ $values['job_info']->Location }}</p>
                                                                        <div class="twm-job-self-mid">
                                                                            <div class="twm-job-self-mid-left">

                                                                                <div class="twm-jobs-amount">
                                                                                    {{ $values['job_info']->Salary }} </div>
                                                                            </div>
                                                                ...
                                                                <ul class="twm-job-hilites2">
                                                                    ...
                                                                    <li>
                                                                        <div class="twm-s-info-inner">
                                                                            <i class="fas fa-calendar-alt"></i>
                                                                            <span class="twm-title">Date Posted</span>
                                                                            <div class="twm-s-info-discription">April 22,
                                                                                2023</div>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="twm-s-info-inner">
                                                                            ...
                                                                            <div class="twm-s-info-discription">Munchen,
                                                                                Germany</div>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                        <div class="twm-s-info-inner">
                                                                            ...
                                                                            <div class="twm-s-info-discription">Web
                                                                                Developer</div>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                    ...
                                                                    <li>
                                                                        <div class="twm-s-info-inner">
                                                                            ...
                                                                            <div class="twm-s-info-discription">Bachelor
                                                                                Degree </div>
                                                                        </div>
                                                                    </li>
                                                                    <li>
                                                                    ...
                                                                    <li>
                                                                        <div class="twm-s-info-inner">
                                                                            ...
                                                                            <div class="twm-s-info-discription">$2000-$2500
                                                                                / Month</div>
                                                                        </div>
                                                                    </li>
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <div class="twm-s-info-inner">
                                                                        ...
                                                                        <div class="twm-s-info-discription">Software
                                                                            Development</div>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="twm-s-info-inner">
                                                                        ...
                                                                        <div class="twm-s-info-discription">+291 560 56456
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                ...
                                                                <li>
                                                                    <div class="twm-s-info-inner">
                                                                        ...
                                                                        <div class="twm-s-info-discription">1363-1385
                                                                            Sunset Blvd Angeles, CA
                                                                            90026 ,USA</div>
                                                                    </div>
                                                                </li>
                ...
                <div class="modal fade twm-sign-up" id="apply_jobsss" aria-hidden="true"
                        ...
                        <div class="modal-content">
                            <form action="apply_job" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title" id="sign_up_popupLabel">Apply for <br> <?php echo $values['job_info']->title; ?>
                                    </h4>
                                            ...
                                            <div class="tab-pane fade show active" id="sign-candidate">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <input name="job_id" type="hidden"
                                                                value="<?php echo $values['job_info']->id; ?>" />
                                                    ...
                                                    <div class="col-lg-12" style="margin-bottom: 16px">
                                                        <input type="file" name="cv_file" id="cv_input2"
                                                            style="display:none;" class="form-control" required="" />
                                                        <label for="cv_input2"
                                                            style="background:#f0f6fe;font-size:14px;width:100%;padding:15px; border-radius:10px;"><img
                                                                src="upload/upload.png" width="24"
                                                                style="margin-right:15px;" /> <span id="file_label3">Click
                                                                to select cv </span></label>
                                                        <script>
