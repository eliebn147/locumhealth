   <!-- FOOTER START -->
            ...
            <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12">
                            ...
                            <div class="widget widget_about">
                                ...
                                <ul class="ftr-list">
                                    <li><p><span>Address :</span> 152-160 City Road, Kemp House, EC1V 2NX</p></li>
                                    <li><p><span>Email :</span>info@locumhealth.co.uk</p></li>
                                    <li><p><span>Call :</span>0203 9315313</p></li>
                                </ul>
                            </div>                            
                ...
                <br>
                   <center>
                            ...
                            <span class="copyrights-text" style="color:#17171d;width:100%;text-align:center;">Copyright © <?php echo date('Y'); ?> All Rights Reserved.</span>
                       </center>
                       <br>
                </div>
        ...
        <!--Model Popup Section Start-->
            <!--Signup popup -->
			   ...
			   <div class="modal fade twm-sign-up" id="refer_friend" aria-hidden="true" aria-labelledby="sign_up_popupLabel" tabindex="-1">
			    ...
			    <div class="modal fade twm-sign-up" id="Submit_Vacancy" aria-hidden="true" aria-labelledby="sign_up_popupLabel" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
            ...
            <div class="modal fade twm-sign-up" id="upload_cv" aria-hidden="true" aria-labelledby="sign_up_popupLabel" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <form action="upload_cv" method="post"  enctype="multipart/form-data" >
                            @csrf
...
<label for="img"  style="background:#f0f6fe;font-size:14px;width:100%;padding:15px; border-radius:10px;"><img src="upload/upload.png" width="24" style="margin-right:15px;" />  <span id="file_lable">Click to select cv </span></label>
