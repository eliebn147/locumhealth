       ...
       <div class="container">
           ...
           <div class="section-content">
               <div class="twm-jobs-grid-wrap">
                   <div class="row">
                       @foreach ($values['jobs_lst'] as $index => $r_data)
                           <div class="col-lg-4 col-md-6">
                               <div class="twm-jobs-grid-style1  ">
                                   ...
                                   <div class="twm-mid-content">
                                       ...
                                       <hr>
                                       <p class="twm-job-address"><i class="fa fa-map-marker" style="color:red"></i>
                                           {{ $r_data->Location }}</p>

                                   </div>
                                   <div class="twm-right-content">

                                       <div class="twm-jobs-amount"><i class="fa fa-money" aria-hidden="true"></i>
                                           {{ $r_data->Salary }} <span></span></div>
                                       <a href="item?title=<?php echo urlencode($r_data->title); ?>"
                                           class="twm-jobs-browse site-text-primary"><?php echo date('d M Y', strtotime($r_data->date)); ?></a>
                                   </div>
                                   <div class="twm-right-content">
                                       ...
                                       <a data-bs-toggle="modal" href="#apply_job{{ $r_data->id }}" role="button"
                           ...
                           <div class="modal fade twm-sign-up" id="apply_job{{ $r_data->id }}" aria-hidden="true"
                                   ...
                                   <div class="modal-content">
                                       <form action="apply_job" method="post" enctype="multipart/form-data">
                                           ...
                                           <div class="modal-header">
                                               <h4 class="modal-title" id="sign_up_popupLabel">Apply for <br>
                                                   {{ $r_data->title }}</h4>
                                                       ...
                                                       <div class="tab-pane fade show active" id="sign-candidate">
                                                           <div class="row">
                                                               ...
                                                               <div class="col-lg-12" style="margin-bottom: 16px">
                                                                   <input type="file" name="cv_file" id="cv_input_{{ $index }}"
                                                                       style="display:none;" class="form-control"
                                                                       required="" />
                                                                   <label for="cv_input_{{ $index }}"
                                                                       style="background:#f0f6fe;font-size:14px;width:100%;padding:15px; border-radius:10px;"><img
                                                                           src="upload/upload.png" width="24"
                                                                           style="margin-right:15px;" /> <span id="file_label_{{ $index }}">Click to select cv
                                                                       </span></label>
                                                                       <script>
                                                                        document.addEventListener('DOMContentLoaded', function() {
                                                                            document.querySelectorAll('input[type="file"]').forEach(function(input, index) {
                                                                                input.addEventListener('change', function(event) {
                                                                                    ...
                                                                                    document.getElementById('file_label_' + index).innerHTML = filename;
                                                                                });
                                                                            });
                                                                        });
                                                                        </script>
                                                               ...
                                                               <div class="col-md-12">
                                                                   <button type="submit"
                                                                       class="site-button">Submit</button>
                                                               </div>
