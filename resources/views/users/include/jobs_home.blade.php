                                    ...
                                    <div class="tab-pane fade show active" id="sign-candidate">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12" style="margin-bottom: 16px">
                                                <input type="file" name="cv_file" id="cv_input4" style="display:none;" class="form-control" required=""/>
                                                <label for="cv_input4" style="background:#f0f6fe;font-size:14px;width:100%;padding:15px; border-radius:10px;"><img src="upload/upload.png" width="24" style="margin-right:15px;" />  <span id="file_label4">Click to select cv </span></label>
                                                <script>
                                                    document.getElementById('cv_input4').onchange = function () {
                                                        var files = event.target.files
      var filename = files[0].name
      var extension = files[0].type
      
      document.getElementById('file_label4').innerHTML = filename;
